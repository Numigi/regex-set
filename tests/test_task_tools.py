...
def test_find_task_details_success(input_, expected):
    assert task_tools.find_task_details(input_) == expected
...
def test_find_task_details_failure(input_):
    assert task_tools.find_task_details(input_) == ("", "")
...
def test_remove_task_from_text(text, task_tag, expected):
    assert task_tools.remove_task_from_text(text, task_tag) == expected
